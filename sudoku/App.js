...
function init() {
	...
	persCamera = new THREE.PerspectiveCamera( 70, window.innerWidth / window.innerHeight, 0.01, 100 );	//camera.position.set(8.5, 8.5, -20);
	persCamera.position.set(40, 40, 35);
